...
秒著是一款软件著作权申请材料自动生成工具，支持一键生成软件概述和设计说明书。

## ✨ 主要功能

- 🆓 **免费模型**：Step 3.5 Flash 完全免费
- 🤖 多模型支持（火山引擎、DeepSeek、智谱GLM、Kimi、MiniMax）
- 📄 自动提取文档信息
- 📝 生成规范的软著申请材料
- 🖼️ 自动提取并嵌入图片
- 📊 自动目录生成
- 🧹 **去AI味处理**：自动替换AI套路用语，生成文档语言风格更接近人工撰写，提高软著审核通过率
- 🔒 安全的API Key管理
...
- ✅ 关闭应用后自动清除
- ✅ 不会上传到任何服务器
- ✅ 本地代理仅监听127.0.0.1，外部无法访问
- ✅ CORS仅允许localhost，防止恶意网站跨域调用
